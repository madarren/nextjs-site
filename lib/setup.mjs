...
export const name = 'Darren Ma';
export const avatar = me;
export const about = () => {
  return (
    <>
      Hey, I'm Darren, a developer who has an interest in frontend web development and game design. I work at JDN as a Software Engineer.
    </>
  );
};
export const bio = () => {
  return (
    <>
      When I'm not coding, I enjoy cooking and playing ice hockey. I also love to travel and explore new places.
    </>
  );
};
`;
  ...
  return (
    <section>
      ...
      <p className="my-5 text-neutral-800 dark:text-neutral-200">
        This is my about page. It is a work in progress.
      </p>
    </section>
  );
}
